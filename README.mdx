...
```mermaid
graph TD
    ROOT["⚡ PROFESSIONAL<br/>EXPERIENCE<br/>⚡"]

    A["🎓 MTs Negeri 1<br/>━━━━━━━━━━<br/>👨‍💻 IT Technician<br/>📅 2022 - Present"]
    A1["⚙️ Infrastructure<br/>🌐 Web Solutions<br/>🛠️ Tech Support"]

    B["🚀 ZEDLABS<br/>━━━━━━━━━━<br/>👔 Founder & CEO<br/>📅 2018 - Present"]
    B1["💼 Consulting<br/>📊 Business<br/>👥 Leadership"]

    C["💻 Freelance<br/>━━━━━━━━━━<br/>🎯 Full-Stack Dev<br/>📅 2017 - Present"]
    C1["🔨 Web Dev<br/>🔗 Integration<br/>📡 Consulting"]
    ...
    style ROOT fill:#FF006E,stroke:#00F5FF,stroke-width:5px,color:#fff,font-weight:bold
    style A fill:#8B5CF6,stroke:#00F5FF,stroke-width:4px,color:#fff
    style B fill:#06B6D4,stroke:#FF006E,stroke-width:4px,color:#fff
    style C fill:#EC4899,stroke:#00F5FF,stroke-width:4px,color:#fff
    style A1 fill:#A855F7,stroke:#00F5FF,stroke-width:2px,color:#fff
    style B1 fill:#14B8A6,stroke:#FF006E,stroke-width:2px,color:#fff
    style C1 fill:#F43F5E,stroke:#00F5FF,stroke-width:2px,color:#fff
```
