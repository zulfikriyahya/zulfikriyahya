...
graph LR
    ...
    style START fill:#FF006E,stroke:#00F5FF,stroke-width:5px,color:#fff
    style A fill:#8B5CF6,stroke:#00F5FF,stroke-width:3px,color:#fff
    style B fill:#06B6D4,stroke:#FF006E,stroke-width:3px,color:#fff
    style C fill:#EC4899,stroke:#00F5FF,stroke-width:3px,color:#fff
