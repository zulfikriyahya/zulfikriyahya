...
stateDiagram-v2
    ...
    state Career_Start {
        [*] --> Freelance_2017
        Freelance_2017: 💻 FREELANCE DEVELOPER
        Freelance_2017: 2017 - Present
        Freelance_2017: Web Dev | Integration | Consulting
    }
    ...
    state Growth {
        [*] --> ZEDLABS_2018
        ZEDLABS_2018: 🚀 FOUNDED ZEDLABS
        ZEDLABS_2018: 2018 - Present
        ZEDLABS_2018: Technology Consulting | Leadership
    }
    ...
    state Current {
        [*] --> MTs_2022
        MTs_2022: 🎓 MTs NEGERI 1 PANDEGLANG
        MTs_2022: 2022 - Present
        MTs_2022: IT Technician | Infrastructure | Web Solutions
    }

    Freelance_2017 --> [*]: Ongoing
    ZEDLABS_2018 --> [*]: Ongoing
    MTs_2022 --> [*]: Ongoing
```
