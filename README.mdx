...
graph LR
    ...
    style START fill:#00DC82,stroke:#1F2937,stroke-width:5px,color:#000
    style A fill:#1F2937,stroke:#00DC82,stroke-width:3px,color:#fff
    style B fill:#00DC82,stroke:#1F2937,stroke-width:3px,color:#000
    style C fill:#374151,stroke:#00DC82,stroke-width:3px,color:#fff
    style A1 fill:#111827,stroke:#00DC82,stroke-width:2px,color:#fff
    style B1 fill:#6EE7B7,stroke:#1F2937,stroke-width:2px,color:#000
    style C1 fill:#4B5563,stroke:#00DC82,stroke-width:2px,color:#fff
```
