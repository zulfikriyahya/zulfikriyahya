...
graph LR
    ...
    style START fill:#FF1493,stroke:#00CED1,stroke-width:5px,color:#fff
    style A fill:#DA70D6,stroke:#00CED1,stroke-width:3px,color:#fff
    style B fill:#00CED1,stroke:#FF1493,stroke-width:3px,color:#000
    style C fill:#FF69B4,stroke:#00CED1,stroke-width:3px,color:#fff
    style A1 fill:#DDA0DD,stroke:#00CED1,stroke-width:2px,color:#000
    style B1 fill:#48D1CC,stroke:#FF1493,stroke-width:2px,color:#000
    style C1 fill:#FFB6C1,stroke:#00CED1,stroke-width:2px,color:#000
```
