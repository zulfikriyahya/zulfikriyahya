...
graph LR
A[2017<br/>FREELANCE<br/>Developer] --> B[2018<br/>ZEDLABS<br/>Founder & CEO]
B --> C[2022<br/>MTs Negeri 1<br/>IT Technician]

    style A fill:#00D9FF,stroke:#00D9FF,color:#000
    style B fill:#FF5D01,stroke:#FF5D01,color:#fff
    style C fill:#512BD4,stroke:#512BD4,color:#fff
