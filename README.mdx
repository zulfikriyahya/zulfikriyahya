...
graph LR
    ...
    style START fill:#FF0080,stroke:#00F0FF,stroke-width:5px,color:#fff
    style A fill:#9D4EDD,stroke:#00F0FF,stroke-width:3px,color:#fff
    style B fill:#00D9FF,stroke:#FF0080,stroke-width:3px,color:#000
    style C fill:#FF006E,stroke:#00F0FF,stroke-width:3px,color:#fff
    style A1 fill:#C77DFF,stroke:#00F0FF,stroke-width:2px,color:#000
    style B1 fill:#7DF9FF,stroke:#FF0080,stroke-width:2px,color:#000
    style C1 fill:#FF69B4,stroke:#00F0FF,stroke-width:2px,color:#fff
```
