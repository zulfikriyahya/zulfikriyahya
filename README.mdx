...
timeline
    ...
    2017 - Present : Freelance Developer
                   : Full-Stack Development
                   : Contract Projects
    2018 - Present : ZEDLABS Teknologi Indonesia
                   : Founder & CEO
                   : Technology Consulting
    2022 - Present : MTs Negeri 1 Pandeglang
                   : IT Technician
...
graph TB
    ...
    B["🎓 MTs Negeri 1 Pandeglang<br/>━━━━━━━━━━━━━━━━"]
    B1["👨‍💻 IT Technician & Full-Stack Developer"]
    B2["📅 2022 - Present"]
    B3["⚙️ Infrastructure Management<br/>🌐 Web Solutions<br/>🛠️ Technical Support"]

    C["🚀 ZEDLABS Teknologi Indonesia<br/>━━━━━━━━━━━━━━━━"]
    C1["👔 Founder & CEO"]
    C2["📅 2018 - Present"]
    C3["💼 Technology Consulting<br/>📊 Business Solutions<br/>👥 Team Leadership"]

    D["💻 Freelance<br/>━━━━━━━━━━━━━━━━"]
    D1["🎯 Full-Stack Developer"]
    D2["📅 2017 - Present"]
    D3["🔨 Contract Web Development<br/>🔗 System Integration<br/>📡 Technical Consulting"]
    ...
    style A fill:#FF006E,stroke:#FF006E,stroke-width:4px,color:#fff,font-size:16px
    style B fill:#8338EC,stroke:#00F5FF,stroke-width:3px,color:#fff
    style C fill:#3A86FF,stroke:#FF006E,stroke-width:3px,color:#fff
    style D fill:#FB5607,stroke:#00F5FF,stroke-width:3px,color:#fff
    style B1 fill:#A855F7,stroke:#00F5FF,stroke-width:2px,color:#fff
    style B2 fill:#7C3AED,stroke:#FF006E,stroke-width:2px,color:#fff
    style B3 fill:#6366F1,stroke:#00F5FF,stroke-width:2px,color:#fff
    style C1 fill:#06B6D4,stroke:#FF006E,stroke-width:2px,color:#fff
    style C2 fill:#0EA5E9,stroke:#00F5FF,stroke-width:2px,color:#fff
    style C3 fill:#3B82F6,stroke:#FF006E,stroke-width:2px,color:#fff
    style D1 fill:#F97316,stroke:#00F5FF,stroke-width:2px,color:#fff
    style D2 fill:#EF4444,stroke:#FF006E,stroke-width:2px,color:#fff
    style D3 fill:#EC4899,stroke:#00F5FF,stroke-width:2px,color:#fff
```
