...
graph LR
    ...
    style A fill:#BC52EE,stroke:#FF5D01,stroke-width:3px,color:#fff
    style B fill:#FF5D01,stroke:#BC52EE,stroke-width:3px,color:#fff
    style C fill:#D946EF,stroke:#FF5D01,stroke-width:3px,color:#fff
    style A1 fill:#C77DFF,stroke:#FF5D01,stroke-width:2px,color:#fff
    style B1 fill:#FF7A3D,stroke:#BC52EE,stroke-width:2px,color:#fff
    style C1 fill:#E879F9,stroke:#FF5D01,stroke-width:2px,color:#fff
```
