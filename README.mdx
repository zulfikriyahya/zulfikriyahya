...
graph LR
    ...
    style START fill:#FF5D01,stroke:#BC52EE,stroke-width:5px,color:#fff
    style A fill:#7C3AED,stroke:#FF5D01,stroke-width:3px,color:#fff
    style B fill:#FF5D01,stroke:#BC52EE,stroke-width:3px,color:#fff
    style C fill:#BC52EE,stroke:#FF5D01,stroke-width:3px,color:#fff
    style A1 fill:#9061F9,stroke:#FF5D01,stroke-width:2px,color:#fff
    style B1 fill:#FF8533,stroke:#BC52EE,stroke-width:2px,color:#fff
    style C1 fill:#D946EF,stroke:#FF5D01,stroke-width:2px,color:#fff
```
